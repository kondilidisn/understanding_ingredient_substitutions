...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_steps", default=1000, type=int) # one epoch is currently 38142 training samples
    ...
    parser.add_argument("--top_prop_percent", default=50, type=int, help="use the least frequent properties (percentage wise)")
